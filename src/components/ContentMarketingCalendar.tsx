import { Calendar, BookOpen, Video, Mail, Share2, TrendingUp, Users, Award, Clock, FileText, MapPin, Star } from 'lucide-react';

const monthlyThemes = [
  {
    month: 'Month 1',
    theme: 'Education',
    description: 'Establish Dr. Duffy as the probate authority through comprehensive educational content',
    weeks: [
      {
        week: 'Week 1',
      ...
      <div className="container-max">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-secondary-600 max-w-3xl mx-auto">
            Strategic content planning to establish Dr. Duffy as Las Vegas's premier 
            probate real estate expert through consistent, valuable content.
          </p>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="space-y-8">
            {monthlyThemes.map((month) => (
              <div key={month.month} className="bg-gradient-to-r from-gray-50 to-white rounded-2xl p-8 border border-gray-200">
                <div className="mb-6">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-1">
                            {week.keywords.map((keyword) => (
                              <span key={keyword} className="text-xs bg-gray-100 text-secondary-600 px-2 py-1 rounded">
                                {keyword}
                              </span>
                            ))}
                          </div>
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-1">
                            {week.distribution.map((platform) => (
                              <span key={platform} className="text-xs bg-green-100 text-green-700 px-2 py-1 rounded">
                                {platform}
                              </span>
                            ))}
                          </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {contentTypes.map((content) => (
              <div key={content.type} className="bg-white rounded-xl shadow-soft p-6 border border-gray-100">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <span className="text-sm text-primary-600 font-medium">{content.frequency}</span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1">
                    {content.platforms.map((platform) => (
                      <span key={platform} className="text-xs bg-gray-100 text-secondary-600 px-2 py-1 rounded">
                        {platform}
                      </span>
                    ))}
                  </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {distributionChannels.map((channel) => (
              <div key={channel.channel} className="bg-white rounded-xl shadow-soft p-6 border border-gray-100">
                <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1">
                    {channel.content.map((item) => (
                      <span key={item} className="text-xs bg-accent-100 text-accent-700 px-2 py-1 rounded">
                        {item}
                      </span>
                    ))}
                  </div>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-primary-50 to-accent-50 rounded-2xl p-8 md:p-12 border border-primary-100">
            ...
            <p className="text-lg text-secondary-600 mb-6 max-w-2xl mx-auto">
              Use this comprehensive content calendar to position Dr. Jan Duffy as 
              Las Vegas's premier probate real estate authority.
            </p>
