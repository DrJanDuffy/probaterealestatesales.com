...
export const metadata: Metadata = {
  ...
  description:
    "Expert probate real estate services in Henderson, Nevada. Green Valley and Anthem probate property expertise with Nevada's fastest timeline: 6-8 months. Free consultation: (702) 830-9222",
  keywords:
    'Henderson probate real estate, Green Valley probate, Anthem probate, Nevada probate timeline, Clark County probate court',
  openGraph: {
    title: 'Henderson Probate Real Estate Services | Green Valley & Anthem Area',
    description:
      'Expert probate real estate services in Henderson with 6-8 month timeline. Free consultation available.',
    type: 'website',
    locale: 'en_US',
  },
};
...
export default function HendersonPage() {
  const breadcrumbs = [
    ...
    { name: 'Henderson', url: '/locations/henderson/' },
  ];

  return (
    <div className="min-h-screen bg-gray-50">
      <Breadcrumb items={breadcrumbs.slice(1)} />
      <SchemaMarkup type="faq" location="Henderson" breadcrumbs={breadcrumbs} />
      ...
      <section className="bg-gradient-to-r from-green-900 to-green-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-4xl mx-auto">
            Expert probate real estate services in Henderson, Nevada. Green Valley and Anthem
            probate property expertise with Nevada's fastest timeline.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Henderson offers unique advantages for probate real estate sales. As Nevada's
                second-largest city, Henderson combines family-friendly neighborhoods with excellent
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Green Valley Ranch, Anthem, and MacDonald Ranch offer excellent probate
                      property opportunities in established neighborhoods.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Specialized knowledge of these master-planned communities and their unique
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Deep understanding of Henderson's real estate market and probate property
                      valuation.
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-gray-100 p-8 rounded-lg">
              ...
              <div className="mt-6 p-4 bg-green-50 rounded-lg">
                <p className="text-sm text-green-800">
                  <strong>Note:</strong> Henderson probate timeline is 6-8 months vs California's
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Master-planned community with excellent schools, parks, and shopping. Popular for
                families and probate properties.
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Upscale community with golf courses and luxury homes. High-end probate real estate
                opportunities.
              </p>
              <div className="space-y-2 text-sm text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Established neighborhood with mature landscaping and family homes. Great probate
                property options.
              </p>
              <div className="space-y-2 text-sm text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                55+ community with active adult lifestyle. Specialized probate services for
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Elevated community with mountain views and custom homes. Luxury probate real estate
                opportunities.
              </p>
              <div className="space-y-2 text-sm text-gray-600">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Henderson residents have convenient access to Clark County's efficient probate court
              system
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-white rounded-lg shadow-lg">
              ...
              <p className="text-gray-600">
                Professional appraisal and market analysis for Henderson properties. Specialized
                knowledge of Green Valley, Anthem, and other neighborhoods.
              </p>
            </div>
      ...
      <section className="py-16 bg-green-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">
            ...
            inherited property in Henderson quickly.
          </p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-gray-900 mb-4">
                Frequently Asked Questions About Henderson Probate
              </h2>
              <p className="text-xl text-gray-600">
                Common questions about probate real estate in Henderson, Nevada
              </p>
            </div>
            <FAQ />
      ...
      <section className="py-8 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Link href="/locations" className="text-green-600 hover:text-green-800 font-semibold">
