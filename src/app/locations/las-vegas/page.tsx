import { ArrowRight, Calendar, Clock, DollarSign, MapPin, Phone, Users } from 'lucide-react';
...
export const metadata: Metadata = {
  ...
  description:
    "Probate Las Vegas expert services. Top probate realtor serving Downtown and Strip areas. Nevada's fastest probate timeline: 6-8 months. Court-approved sales, inherited property expert. Free consultation: (702) 830-9222",
  keywords:
    'probate las vegas, Las Vegas probate, probate realtor Las Vegas, Las Vegas probate real estate, downtown probate, strip area probate, Nevada probate timeline, Clark County probate court, probate las vegas nevada',
  openGraph: {
    title: 'Probate Las Vegas | Expert Probate Realtor | Downtown & Strip Area Services',
    description:
      "Probate Las Vegas expert services. Top probate realtor serving Downtown and Strip areas. Nevada's fastest probate timeline: 6-8 months. Free consultation available.",
    type: 'website',
    locale: 'en_US',
  },
};
...
export default function LasVegasPage() {
  const breadcrumbs = [
    ...
    { name: 'Las Vegas', url: '/locations/las-vegas/' },
  ];

  return (
    <div className="min-h-screen bg-gray-50">
      <Breadcrumb items={breadcrumbs.slice(1)} />
      <SchemaMarkup type="faq" location="Las Vegas" breadcrumbs={breadcrumbs} />
      ...
      <section className="bg-gradient-to-r from-blue-900 to-blue-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-4xl mx-auto">
            Expert probate real estate services in Las Vegas, Nevada. Downtown and Strip area
            probate property sales with Nevada's fastest timeline.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Las Vegas offers unique advantages for probate real estate sales. With direct access
                to Clark County's probate court system and a diverse real estate market, we can help
                you navigate inherited property sales efficiently.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Convenient access to Clark County Regional Justice Center and probate court
                      proceedings.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Quick property valuation and market assessment for downtown and Strip area
                      properties.
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-gray-100 p-8 rounded-lg">
              ...
              <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-800">
                  <strong>Note:</strong> Las Vegas probate timeline is 6-8 months vs California's
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <div className="mt-6 p-4 bg-green-50 rounded-lg">
                <p className="text-sm text-green-800">
                  <strong>Savings:</strong> Nevada probate costs are significantly lower than
                  California, with faster timelines and more efficient court processes.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">
            ...
            inherited property in Las Vegas quickly.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            >
              ...
              <p className="text-secondary-600 text-sm">
                Complete probate property services for Las Vegas estates.
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-secondary-600 text-sm">
                Complete guide to Nevada probate process and requirements.
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-secondary-600 text-sm">
                Latest Las Vegas probate property market trends and insights.
              </p>
            </Link>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Common questions about probate real estate in Las Vegas, Nevada
              </p>
            </div>
            <FAQ />
