...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Summerlin Probate Real Estate Services | Master-Planned Community',
    description: 'Expert probate real estate services in Summerlin with 6-8 month timeline. Free consultation available.',
    type: 'website',
    locale: 'en_US',
  },
};
...
export default function SummerlinPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      <SchemaMarkup type="location" location="Summerlin" />
      ...
      <section className="bg-gradient-to-r from-purple-900 to-purple-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-4xl mx-auto">
            Expert probate real estate services in Summerlin, Nevada. 
            Master-planned community with luxury homes and golf course properties.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Summerlin represents the pinnacle of master-planned community living in Las Vegas. With its luxury homes, golf courses, and upscale amenities, Summerlin offers unique probate real estate opportunities that require specialized expertise.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">High-end properties with premium features, requiring specialized probate real estate expertise for proper valuation and marketing.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Properties with Red Rock Canyon views offer exceptional probate real estate opportunities in Summerlin's most desirable areas.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-100 p-8 rounded-lg">
              ...
              <div className="mt-6 p-4 bg-purple-50 rounded-lg">
                <p className="text-sm text-purple-800">
                  <strong>Note:</strong> Summerlin probate timeline is 6-8 months vs California's 9-18 months. 
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Ultra-luxury community with custom homes and Red Rock Canyon views. Premium probate real estate opportunities.
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Golf course community with luxury homes and mountain views. High-end probate properties available.
              </p>
              <div className="space-y-2 text-sm text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Upscale community with Mediterranean-style homes and resort-style living. Excellent probate opportunities.
              </p>
              <div className="space-y-2 text-sm text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Nature-focused community with hiking trails and mountain views. Unique probate property options.
              </p>
              <div className="space-y-2 text-sm text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Elevated community with panoramic views and luxury homes. Premium probate real estate market.
              </p>
              <div className="space-y-2 text-sm text-gray-600">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Specialized valuation for custom luxury homes with unique features</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Expertise in valuing properties with mountain and canyon views</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Professional photography and luxury presentation</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Confidential marketing for high-profile probate properties</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Summerlin residents have convenient access to Clark County's efficient probate court system
            </p>
          </div>
      ...
      <section className="py-16 bg-purple-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">
            ...
            can help you sell inherited property in Summerlin quickly.
          </p>
