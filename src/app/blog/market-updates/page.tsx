...
import { TrendingUp, ArrowLeft, Calendar, BarChart, DollarSign } from 'lucide-react';

export const metadata: Metadata = {
  title: 'Las Vegas Real Estate Market Updates | Probate Property Trends',
  description: 'Stay informed with the latest Las Vegas real estate market trends, probate property insights, and market analysis from Dr. Jan Duffy.',
  keywords: 'Las Vegas real estate market, probate property trends, real estate market updates, Las Vegas housing market, probate sales data',
  alternates: {
    canonical: 'https://www.probaterealestatesales.com/blog/market-updates/',
  },
  openGraph: {
    title: 'Las Vegas Real Estate Market Updates',
    description: 'Stay informed with the latest Las Vegas real estate market trends and probate property insights.',
    type: 'website',
          ...
          <div className="space-y-8">
            ...
            <article className="bg-white rounded-xl shadow-md p-8 border border-gray-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-secondary-700 mb-4 leading-relaxed">
                The Las Vegas probate real estate market continues to show strong activity with an average 
                time on market of 45-60 days for well-priced properties. Inventory levels remain stable, 
                and buyer interest in probate properties continues to grow due to potential value opportunities.
              </p>
              <div className="grid md:grid-cols-3 gap-6 my-6">
                <div className="bg-blue-50 rounded-lg p-4">
                  <div className="flex items-center mb-2">
                    <DollarSign className="h-5 w-5 text-blue-600 mr-2" />
                    <span className="text-sm font-medium text-secondary-700">Average Sale Price</span>
                  </div>
              ...
              <Link href="/blog/las-vegas-market-jan-2025" className="text-primary-600 hover:text-primary-800 font-medium">
                Read Full Report →
              </Link>
            </article>
            ...
            <div className="bg-gray-50 rounded-xl p-8 text-center border-2 border-dashed border-gray-300">
              ...
              <p className="text-secondary-600 mb-4">
                We'll be posting regular market updates with detailed analysis of Las Vegas probate property trends.
              </p>
              <Link
                href="/contact"
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-md">
              ...
              <p className="text-secondary-600">
                Nevada's 6-8 month probate timeline continues to attract families from states with longer processes, 
                making probate properties an attractive option for buyers.
              </p>
            </div>
            <div className="bg-white rounded-xl p-8 shadow-md">
            ...
            <div className="bg-white rounded-xl p-8 shadow-md">
              ...
              <p className="text-secondary-600">
                The Las Vegas probate property market shows steady growth and stability, 
                making it an ideal time for both buyers and sellers.
              </p>
            </div>
          </div>
        </div>
