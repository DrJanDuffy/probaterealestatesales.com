...
import { TrendingUp, ArrowLeft, Calendar, BarChart, DollarSign, Home } from 'lucide-react';

export const metadata: Metadata = {
  title: 'Las Vegas Probate Property Market Update January 2025 | Real Estate Trends',
  description: 'Comprehensive Las Vegas probate real estate market update for January 2025. Analysis of sale prices, days on market, inventory levels, and probate property trends.',
  keywords: 'Las Vegas real estate market 2025, probate property market, Las Vegas housing market, probate sales trends, January 2025 market update',
  alternates: {
  ...
  openGraph: {
    ...
    description: 'Comprehensive analysis of Las Vegas probate real estate market trends for January 2025.',
    type: 'article',
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-blue-900 to-blue-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link href="/blog/market-updates" className="inline-flex items-center text-primary-100 hover:text-white mb-6">
          ...
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Comprehensive analysis of probate real estate trends and market conditions in Las Vegas.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-lg text-secondary-700 mb-6 leading-relaxed">
              The Las Vegas probate real estate market continues to demonstrate strong activity and stability 
              as we enter 2025. Well-priced probate properties are attracting significant buyer interest, 
              with average days on market remaining competitive at 45-60 days. The market shows healthy 
              inventory levels and steady pricing trends that benefit both buyers seeking value opportunities 
              and families looking to liquidate estate properties efficiently.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white rounded-xl shadow-lg p-8 text-center">
              ...
              <p className="text-sm text-secondary-500 mt-4">
                Probate properties continue to appreciate, with strong buyer demand driving competitive pricing.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 text-center">
              ...
              <p className="text-sm text-secondary-500 mt-4">
                Properties priced correctly are selling faster, indicating strong market fundamentals.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 text-center">
              ...
              <p className="text-sm text-secondary-500 mt-4">
                Balanced market conditions with healthy inventory levels supporting steady sales activity.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            <div className="bg-blue-50 rounded-lg p-8 border-l-4 border-blue-600">
              ...
              <p className="text-secondary-700 mb-4">
                Probate property prices have shown consistent appreciation, with the average sale price increasing 
                3.2% year-over-year. This growth is driven by several factors:
              </p>
            ...
            <div className="bg-green-50 rounded-lg p-8 border-l-4 border-green-600">
              ...
              <p className="text-secondary-700 mb-4">
                The average days on market decreased by 5 days compared to the previous quarter, indicating 
                strong buyer activity. Key observations:
              </p>
              <ul className="list-disc list-inside space-y-2 text-secondary-700">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-white rounded-lg p-6 shadow-md">
              ...
              <p className="text-secondary-700 mb-3">
                Premium properties in Summerlin continue to command strong prices, with average sale prices 
                above market average. Days on market: 38-50 days.
              </p>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md">
              ...
              <p className="text-secondary-700 mb-3">
                Steady activity in Henderson with consistent pricing. Well-maintained properties in Green Valley 
                and Anthem areas selling quickly. Days on market: 45-60 days.
              </p>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md">
              ...
              <p className="text-secondary-700 mb-3">
                Downtown and central Las Vegas properties showing consistent activity. Investor interest 
                remains strong. Days on market: 40-55 days.
              </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg text-secondary-700 mb-4">
              Looking ahead, we expect the Las Vegas probate property market to maintain its current strength 
              through the first half of 2025. Key factors supporting this outlook include:
            </p>
            <ul className="space-y-3 text-secondary-700">
              ...
              <li className="flex items-start">
                <TrendingUp className="h-6 w-6 text-green-600 mr-3 mt-0.5 flex-shrink-0" />
                <span>Nevada's favorable probate timeline (6-8 months) attracting out-of-state families</span>
              </li>
              <li className="flex items-start">
                <TrendingUp className="h-6 w-6 text-green-600 mr-3 mt-0.5 flex-shrink-0" />
            ...
            <p className="text-lg text-secondary-700 mt-6">
              Families selling probate properties should work with experienced probate real estate specialists 
              to ensure proper pricing and efficient sales processes. Well-priced properties in good condition 
              continue to attract competitive offers and close successfully.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-primary-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
            Get a free market analysis and pricing strategy tailored to your probate property's location and condition.
          </p>
          <Link
            href="/contact"
