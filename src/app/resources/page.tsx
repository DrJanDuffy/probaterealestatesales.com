      ...
      <section className="py-16 bg-gray-50">
        <div className="container-max">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <a href="#educational-content" className="bg-white rounded-xl shadow-soft p-6 border border-gray-100 hover:shadow-lg transition-shadow duration-300 text-center group">
            ...
            <a href="#nevada-laws" className="bg-white rounded-xl shadow-soft p-6 border border-gray-100 hover:shadow-lg transition-shadow duration-300 text-center group">
            ...
            <a href="#probate-timeline" className="bg-white rounded-xl shadow-soft p-6 border border-gray-100 hover:shadow-lg transition-shadow duration-300 text-center group">
            ...
            <a href="#property-checklist" className="bg-white rounded-xl shadow-soft p-6 border border-gray-100 hover:shadow-lg transition-shadow duration-300 text-center group">
            ...
            <a href="#cost-calculator" className="bg-white rounded-xl shadow-soft p-6 border border-gray-100 hover:shadow-lg transition-shadow duration-300 text-center group">
            ...
            <a href="#marketing-tools" className="bg-white rounded-xl shadow-soft p-6 border border-gray-100 hover:shadow-lg transition-shadow duration-300 text-center group">
